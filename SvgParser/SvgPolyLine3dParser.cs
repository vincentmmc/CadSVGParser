...
{
    class SvgPolyLine3dParser : SvgParserBase
    {
        private Polyline3d _line;
        public SvgPolyLine3dParser(Entity entity, Dictionary<ObjectId, LayerInfo> layerInfo) : base(entity, layerInfo)
        {
            this._line = this._entity as Polyline3d;
